...
ALTER TABLE IF EXISTS "BasicQuestionBank"      ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AdvancedQuestionBank"   ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "BasicQuestionOption"    ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AdvancedQuestionOption" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "BasicLesson"            ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AdvancedLesson"         ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "BasicLessonProgress"    ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AdvancedLessonProgress" ENABLE ROW LEVEL SECURITY;
